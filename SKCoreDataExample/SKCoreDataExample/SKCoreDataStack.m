...
@interface SKCoreDataStack ()

- (NSURL *)applicationDocumentsDirectory;

@end

@implementation SKCoreDataStack {}
...
- (NSFetchedResultsController *)frcWithEntityNamed:(NSString *)entityName withPredicateFormat:(NSString *)predicate predicateObject:(id)predicateObject sortDescriptors:(NSString *)sortDescriptors andSectionNameKeyPath:(NSString *)sectionName
{
    ...
    return [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:sectionName cacheName:NULL];
}
